            ...
            <div className="w-[82%] max-w-3xl mx-auto py-24">
                ...
                <div className="space-y-14 font-body text-ink/80 dark:text-ink/80 leading-relaxed text-sm">
                    <section className="space-y-4">
                        <p>
                            Axiom is the philosophy society at NSUT. This policy
                            explains what information is collected when you
                            visit this website and how it is used.
                        </p>
                        <p>
                            We respect your privacy. We do not track you across
                            sites, we do not sell or share any data with third
                            parties, and we do not use advertising cookies.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="space-y-4">
                            <p>
                                ...
                                — an open-source, cookieless analytics platform
                                — to understand how many people visit each page.
                            </p>
                            ...
                            <div className="border border-gold/20 divide-y divide-gold/20">
                                {[
                                    ...
                                    >
                                        <span className="font-mono text-xs text-gold uppercase tracking-widest w-32 shrink-0 pt-0.5">
                                            {label}
                                        </span>
                            ...
                            <p className="text-xs text-ink/40">
                                GoatCounter is GDPR-friendly by design. Learn
                                more at{' '}
                                <a
                                    href="https://www.goatcounter.com/help/privacy"
                                    target="_blank"
                    ...
                    <section>
                        ...
                        <div className="space-y-4">
                            ...
                            <p>
                                Fonts are loaded from Google Fonts. Google may
                                record font requests; see the{' '}
                                <a
