                    ...
                    <section>
                        ...
                        <div className="space-y-4 text-sm">
                            <div className="flex gap-6 items-baseline">
                                <span className="font-heading text-2xl font-light text-green w-48 shrink-0">
                                    Cormorant Garamond
                                </span>
                                <span className="text-ink/60">
                                    Headings and display text — a revival of the
                                    16th-century Garamond typeface, chosen for
                                    its scholarly warmth.
                                </span>
                            </div>
                            <div className="border-t border-gold/20" />
                            <div className="flex gap-6 items-baseline">
                                <span className="font-body text-base w-48 shrink-0">
                                    DM Sans
                                </span>
                                <span className="text-ink/60">
                                    Body copy and UI labels — a low-contrast
                                    geometric grotesque designed for screen
                                    legibility.
                                </span>
                            </div>
                            <div className="border-t border-gold/20" />
                            <div className="flex gap-6 items-baseline">
                                <span className="font-mono text-sm w-48 shrink-0">
                                    IBM Plex Mono
                                </span>
                                <span className="text-ink/60">
                            ...
                            {[
                                ...
                                >
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="font-mono text-[9px] tracking-[0.18em] uppercase text-terracotta/60">
                                            {tag}
                                        </span>
                                    </div>
