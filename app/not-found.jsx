...
export const metadata = {
    title: '404: Not Found | Axiom',
    description: 'The page you have requested exists only in your mind.',
}

export default function NotFound() {
    return (
        <div className="bg-cream dark:bg-[#0E1A14] min-h-[70vh] flex flex-col items-center justify-center px-6 text-center pt-24 pb-16">
