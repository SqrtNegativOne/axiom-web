...
const STEPS = [
    {
        ...
        aArgument:
            'Average welfare falls. The original people deserve to keep their quality of life.',
    },
    {
        aLabel: 'World A+',
        bLabel: 'World B',
    ...
    },
    {
        ...
        aArgument:
            'Average welfare fell from 75 to 56. Adding lower-welfare lives drags down the mean.',
    },
    {
        aLabel: 'World B+',
        bLabel: 'World C',
        ...
        aArgument:
            '(Same population and total welfare — only equality changes.)',
        tricky: true,
    },
    {
        aLabel: 'World C',
    ...
    },
    {
        ...
        aArgument:
            "These lives are miserable by any ordinary standard. 'Barely worth living' is not what we owe future people.",
        final: true,
    },
]
                ...
                <div style={{ maxWidth: 600, margin: '0 auto' }}>
                    ...
                    <div style={{ display: 'flex', gap: 10, marginBottom: 20 }}>
                        <World
                            ...
                            pending={
                                selected === null && pendingChoice === false
                            }
                            onSelect={() => {
                        ...
                        <World
                            ...
                            pending={
                                selected === null && pendingChoice === true
                            }
                            onSelect={() => {
                            ...
                            >
                                ...
                                >
                                    {selected
                                        ? current.bArgument
                                        : current.aArgument ||
                                          'You resisted the addition of lower-welfare lives.'}
                                </p>
                            </div>
    ...
    if (phase === 'conclusion') {
        ...
        `}</style>
                <div style={{ maxWidth: 580, margin: '0 auto' }}>
                    ...
                    >
                        {chainToZ
                            ? 'You have endorsed the Repugnant Conclusion.'
                            : 'You resisted — but at a cost.'}
                    </h2>
                    ...
                    {chainToZ ? (
                        <>
                            ...
                            >
                                ...
                                makes it better, and (2) equal welfare
                                distributions are at least as good as unequal
                                ones with the same total. Together, via
                                transitivity, they force Z ≥ A.
                            </p>
                        </>
                    ) : (
                        <div
                        ...
                        >
                            ...
                            >
                                ...
                                {STEPS[firstRefusal].aLabel}. This blocks the
                                Repugnant Conclusion — but it requires accepting
                                that adding lives with positive welfare does not
                                always improve the world. You must explain{' '}
                                <em>why</em> the addition is bad despite each
                                new life being worth living.
                            </p>
                        </div>
                    )}
