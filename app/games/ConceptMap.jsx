...
const PUZZLES = [
    {
        ...
        explanation:
            'Justice grounds ethics, ethics requires reason, reason is a faculty of mind, mind includes consciousness.',
    },
    {
        start: 'beauty',
        end: 'god',
        ...
        explanation:
            'Beauty implies harmony, harmony found in nature, nature leads to its creator or ground.',
    },
    {
        start: 'doubt',
        end: 'freedom',
        ...
        explanation:
            'Doubt undermines certainty, certainty is sought through knowledge, knowledge relies on reason, reason grounds ethics, ethics requires freedom.',
    },
]
...
export default function ConceptMap() {
    ...
    const currentConcept =
        path.length === 0 ? puzzle.start : path[path.length - 1]
        ...
        return (
            <div style={S.root}>
                <div style={S.endBox}>
                    ...
                    <div style={S.endSub}>
                        All three concept bridges crossed.
                    </div>
                </div>
            </div>
        )
    ...
    return (
        <div style={S.root}>
            <div style={S.topBar}>
                ...
                <span style={S.puzzleCount}>
                    {puzzleIdx + 1} / {PUZZLES.length}
                </span>
            </div>

            <div style={S.instruction}>
                Connect two philosophical concepts via the shortest possible
                chain of related ideas.
            </div>
            ...
            {!won && !showSolution && (
                <div style={S.inputRow}>
                    <div style={S.fromLabel}>
                        From <strong>{currentConcept}</strong>, go to:
                    </div>
            ...
            {won && (
                <div style={S.wonBox}>
                    <div style={S.wonTitle}>
                        Path found — {pathLen - 1} step
                        {pathLen - 2 !== 1 ? 's' : ''}
                    </div>
                    <div style={S.wonDetail}>
                        Optimal: {optimalLength - 1} steps
                        {pathLen === optimalLength
                            ? ' — perfect!'
                            : pathLen <= optimalLength + 1
                              ? ' — near-optimal.'
                              : '.'}
                    </div>
