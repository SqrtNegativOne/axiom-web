...
export const FALLACY_OPTS = [
    ...
    },
    {
        ...
        cls: 'Relevance',
        definition:
            "Treating an expert's opinion as conclusive proof outside their domain of expertise.",
    },
    {
        name: 'Straw man',
        family: 'Informal',
        cls: 'Relevance',
        definition:
            "Misrepresenting an opponent's argument into a weaker version, then refuting that instead.",
    },
    {
        ...
        cls: 'Relevance',
        definition:
            'Arguing something is right or good simply because it has always been done that way.',
    },
    {
    ...
    },
    {
        ...
        cls: 'Relevance',
        definition:
            'Judging a claim based on its origin or source rather than its own merits.',
    },
    {
        ...
        cls: 'Relevance',
        definition:
            'Arguing that something is good or right because it is natural, or bad because it is unnatural.',
    },
    {
        name: 'False dilemma',
        family: 'Informal',
        cls: 'Presumption',
        definition:
            'Presenting only two options as if they are the only possibilities when others exist.',
    },
    {
        name: 'Slippery slope',
        family: 'Informal',
        cls: 'Presumption',
        definition:
            'Claiming one event will inevitably trigger a chain of extreme consequences without justification.',
    },
    {
        ...
        cls: 'Presumption',
        definition:
            'Drawing a broad conclusion from an unrepresentative or insufficient sample.',
    },
    {
        ...
        cls: 'Presumption',
        definition:
            'Using the conclusion as a hidden premise to support itself.',
    },
    {
        ...
        cls: 'Presumption',
        definition:
            'Dismissing counterexamples by arbitrarily redefining the category to exclude them.',
    },
    {
    ...
    },
    {
        ...
        cls: 'Ambiguity',
        definition:
            "Exploiting a word's multiple meanings to shift between senses mid-argument.",
    },
    {
    ...
    },
    {
        ...
        cls: 'Formal',
        definition:
            'Inferring the negation of the consequent from the negation of the antecedent: "If P then Q; not P; therefore not Q."',
    },
    {
        name: 'No fallacy',
        family: 'Valid',
        ...
        noLabel: true,
        definition:
            'The argument is logically sound: its premises genuinely support its conclusion without exploiting bias, misrepresentation, or structural error.',
    },
]
