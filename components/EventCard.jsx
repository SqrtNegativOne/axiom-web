...
export default function EventCard({
    ...
    const images =
        imageFolder && imageManifest.events[imageFolder]
            ? imageManifest.events[imageFolder].map(
        ...
        >
            ...
            <div className="min-w-0">
                ...
                <div className="flex flex-wrap gap-4 mb-2 items-center">
                    <span className="font-mono text-gold text-xs tracking-widest">
                        {date}
                    </span>
                    <span className="font-mono text-ink/40 text-xs tracking-wider">
                        ·
                    </span>
                    <span className="font-mono text-ink/50 text-xs tracking-wider">
                        {location}
                    </span>
                </div>
