...
export default function PhilosopherMatch() {
    ...
    const progress =
        (roundIdx * ROUNDS[0].quotes.length + quoteIdx + (correct ? 1 : 0)) /
        (ROUNDS.length * ROUNDS[0].quotes.length)
        ...
        return (
            <div style={styles.root}>
                <div style={styles.card}>
                    ...
                    <div style={styles.endScore}>
                        {score} / {total}
                    </div>
                    <div style={styles.endPct}>{pct}% accuracy</div>
                    <div style={styles.endLabel}>
                        {pct >= 80
                            ? 'Prodigious. Hume himself would approve.'
                            : pct >= 55
                              ? 'Respectable. A few more centuries to study.'
        ...
        <div style={styles.root}>
            ...
            <div style={styles.card}>
                ...
                {correct && (
                    <div style={styles.correctBanner}>
                        ✓ {quote.philosopher}
                        {attempts === 0 && (
                            <span style={styles.pointsBadge}>+3</span>
                        )}
                        {attempts === 1 && (
                            <span style={styles.pointsBadge}>+2</span>
                        )}
                        {attempts >= 2 && (
                            <span style={styles.pointsBadge}>+1</span>
                        )}
                    </div>
                )}
            </div>
            ...
            {correct && (
                <button style={styles.nextBtn} onClick={next}>
                    {quoteIdx + 1 < round.quotes.length ||
