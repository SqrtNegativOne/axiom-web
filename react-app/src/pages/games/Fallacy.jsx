...
const RESULT_STYLES = {
  ...
  cls: {
    ...
    style: { background: '#C9A44C22', borderColor: '#C9A44C66', color: '#7A5C1E' },
    label: 'Same class',
  ...
  fam: {
    ...
    style: { background: '#4A6A8822', borderColor: '#4A6A8844', color: '#2A4A68' },
    label: 'Same family',
    ...
    <div className="max-w-2xl mx-auto">
      ...
      {status === 'lose' && (
        <div className="bg-terracotta/8 border border-terracotta/25 rounded-lg px-5 py-4">
          ...
          <p className="font-heading text-xl font-light text-ink mb-2">{puzzle.answer}</p>
          <p className="font-body text-sm text-ink/65 leading-relaxed">{puzzle.explanation}</p>
        </div>
      )}
