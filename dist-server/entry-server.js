...
function SectionDivider$1({ className = "" }) {
...
function PullQuote$1({ children, attribution, className = "" }) {
  return /* @__PURE__ */ jsxs(
    "blockquote",
    {
...
function Team() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "pt-20 animate-on-load", children: [
    ...
    /* @__PURE__ */ jsx(SectionDivider$1, { className: "px-6 max-w-6xl mx-auto" }),
    ...
    /* @__PURE__ */ jsxs("section", { className: "max-w-4xl mx-auto px-6 py-16", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-10", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx(PullQuote$1, { children: "Philosophy begins in wonder. And at Axiom, the wonder never stops." }),
          /* @__PURE__ */ jsxs(
            "p",
            {
              className: "font-body text-ink/70 leading-relaxed mt-4",
